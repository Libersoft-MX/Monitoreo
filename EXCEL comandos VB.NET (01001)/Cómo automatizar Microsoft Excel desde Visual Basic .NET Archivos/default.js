...
// function to check if the browser is running on high contrast or low contrast 
//based on the background image being set to none in high contrast and css change 
//that occurs in high contrast mode.
function isHighContrast() {
    var defaults = {
        divid: 'jQueryHighContrastDetection',
        image: '..\library\images\2027272.jpg',
        StyleSheet: 'css/highcontrast.css'
    };
    var IsHighContrast = false;
    var options = $.extend(defaults, options);
    var hcDetect = jQuery('<divid="' + options.divid + '"></div>').css(
...
function MS_StatsDotNet() {
    ...
    this.LogPageOnLoad = function () {
       ...
       $('#StatsDotNetImg').attr("src",ltsUrl);
    }
